...
<!--                                        <a href="{{ url('find-cars') }}" class="btn-memberarea-slider1">Search for a car</a>
    ...
    function addToWishlist(){
            ...
            var makes = $('#makesWishlist').val();
            var makeModel = makes+' '+vehicleTitle;
            var price = $('#priceWishlist').val();
              price = "£ "+price;
            var vehicleTransmission = $('#transmissionTable').html();
            var vehicleMileage = $('#mileageTable').html();
            var vehicleDistance = '';
            var registerationInfo = $('#registrationWishlist').val();
            var vehicleFuel = $('#fuelTable').html();
            var vehicleImage = $('#imageWishlist').val();
            var dealerName = '';
            var color = $('#colorTable').html();
