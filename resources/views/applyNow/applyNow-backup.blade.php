...
<div class="container contentDiv">
    ...
    <form id="msform" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="vid" value="{{ Request::query('vid') }}" />
...
<!--Bank Information-->
        <fieldset class="BankVerification">
            <div class="col-sm-12 formDiv">
                ...
                <h3>We can only offer loans to customers with valid UK debit cards.</h3>
                <h4>Your bank account details are 100% secure cannot be used for loan repayments that comes later.</h4>
                <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-xs-12">
                <!--<div class="col-sm-offset-3 col-sm-6">-->
...
<!--            <input  id="firstForm" type="button" name="next" class=" next action-button" value="Next Step" />-->
                ...
                <div class="apply-last-p">
                    <p>By submitting your application, you agree to our <a href="/terms-and-conditions/" target="_blank">terms &amp; conditions</a> and <a href="/privacy-policy/" target="_blank">privacy policy</a>.</p>
                    <p>Here at Quick Car Finance we take your privacy seriously and only use your personal information to administer your account to provide the products and services you have requested.</p>
                    <p>From time to time we'd like to contact you with details of our other products as well as third-party products we believe will be of interest. If you consent to this please tick the boxes below to specify how you'd like to be contacted.</p>
                </div>
                ...
                <div class="apply-last-p">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <!--<label for="checkbox3" class="final-step-check-label" style="margin-right:15px">
                                To make choices on which companies/products you'd like to hear about please <a href="#" data-toggle="modal" data-target="#customiseMarketing">click here</a>.
                            </label>
                            <input class="final-step-check"  id="checkbox3" name="ck" type="checkbox">-->
          ...
          <div class="apply-last-p">
              <!--<p class="sh-marketing-text">-->
                  ...
                  <label for="checkbox3" class="final-step-check-label" style="margin-left: 0">
                      Receive electronic marketing with other Automotive Online Ltd offers
                  </label>


                  <!--Receive electronic marketing with other Automotive Online Ltd offers-->
                 <!-- Receive electronic marketing with other <br class="visible-xs">Sandhurst credit &amp; loan offers.-->
               <!-- <span>
                    <label for="sh-marketing" class="label-sh-marketing">
                        <input type="checkbox" name="AgreeToMarketing" value="" id="sh-marketing" checked="">
                        <span></span>
                    </label>
                </span>-->
              <!--</p>-->
