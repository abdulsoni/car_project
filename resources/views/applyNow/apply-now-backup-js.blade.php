...
$(window).scrollTop(0);
 ...
 if(emonths==''){
  ...
  if(eyear<=0 && emonths<=0){
      ...
      if(eyear>99){
          swal("Error!", "Employment years should be valid!", "error");
      }
      else {
          if(emonths>11){
  ...
  if(eyear<=0 && emonths<=0){
      ...
      if(eyear>99){
          ...
          if(emonths>11){
              ...
              // if(totalMonths<36){
              var empURL = "{{ route('save-employement-data1') }}";
              var data = {
              ...
              monthlyIncome:$.cookie('qcf_monthlyIncome1')
              }
              $.ajax({
              headers: {
      ...
      if(eyear>99){
          ...
          if(emonths>11){
              ...
              var data = {
                  ...
                  empMonths:emonths,
                  totalMonths:totalMonths,
                  monthlyIncome:$.cookie('qcf_monthlyIncome2')
              }
                  $.ajax({
                  headers: {
                      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
$(window).scrollTop(0);
  ...
  var secondStreet = $.cookie('qfc_secondStreet');
  ...
  if(street!=''){
    if(buildingNumber!=''){
      street = street.replace(buildingNumber,'');
    }
  }else{
    street = buildingName;
  }
...
var secondStreet = $.cookie('qfc_secondStreet2');
