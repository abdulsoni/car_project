...
@section('seo-content')
<title>Apply Now for Car Finance UK | Apply Car Loans UK - Quickcarfinance.co.uk</title>
<meta name="description" content="Quickcarfinance.co.uk is #1 online today apply now for car finance and quick to apply car loans accept in in Dorset Bournemouth UK. Compare the best car finance loans low rates calculator broker bad credit 2019."/>
<meta name="keywords" content="apply now for car finance uk, apply car loans uk, accept car finance, apply car loan, apply now for car finance"/>
<link rel="canonical" href="https://www.quickcarfinance.co.uk/apply-now"/>
...
<meta property="og:title" content="Apply Now for Car Finance UK | Apply Car Loans UK - Quickcarfinance.co.uk"/>
<meta property="og:description" content="Quickcarfinance.co.uk is #1 online today apply now for car finance and quick to apply car loans accept in in Dorset Bournemouth UK. Compare the best car finance loans low rates calculator broker bad credit 2019."/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="https://www.quickcarfinance.co.uk/apply-now"/>
<meta property="og:site_name" content="Quickcarfinance.co.uk"/>
<meta itemprop="url" content="https://www.quickcarfinance.co.uk/apply-now"/>
<meta itemprop="name" content="Quickcarfinance"/>
<meta itemprop="description" content="Quickcarfinance.co.uk is #1 online today apply now for car finance and quick to apply car loans accept in in Dorset Bournemouth UK. Compare the best car finance loans low rates calculator broker bad credit 2019."/>
<meta name="twitter:card" content="summary" />
<meta name="twitter:url" content="https://www.quickcarfinance.co.uk/apply-now"/>
<meta name="twitter:title" content="Apply Now for Car Finance UK | Apply Car Loans UK - Quickcarfinance.co.uk"/>
<meta name="twitter:description" content= "Quickcarfinance.co.uk is #1 online today apply now for car finance and quick to apply car loans accept in in Dorset Bournemouth UK. Compare the best car finance loans low rates calculator broker bad credit 2019."/>
...
.rangeInput>.asRange .asRange-pointer:after {
...
.asRange .asRange-selected {
    ...
    /* background: linear-gradient(#45a9ff,#2777bb); */
    background-image: linear-gradient(to right, {{$secondary}}, {{$secondary}} , {{$secondary}} , {{$secondary}}, {{$secondary}});
    /* border-radius: 3px; */
}
...
.progress-line {
    ...
    height: 2px;
    border-image: linear-gradient(to right, {{$primary}}, {{$primary}} ,{{$primary}});
    color: {{$primary}} !important;
}

.rangeInput>.asRange>.asRange-selected,
.progress-line
{
...
<!--    Select Car-->
        <fieldset class="firstForm">
           ...
           <!-- <h1 class="apply-now-top">What Vehicle Would You Like?</h1>-->
                ...
                <button onclick="topFunction()" id="firstForm" type="button" name="next" class="next action-button apply-now-continue-btn" >Continue</button>
                </a>
        </fieldset>
...
<!--Select Budget-->
        <fieldset class="secondForm">
            ...
            <button id="secondForm" type="button" name="next" class="next action-button apply-now-continue-btn" >Continue</button>
        </fieldset>
...
<!--        select Driving Licence-->
        <fieldset class="thirdForm">
            ...
            <button id="thirdForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
...
Partnership</h3>
            ...
            <button id="fourthForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
...
<!--        Select passport Info-->
        <fieldset class="fifthForm">
            ...
            <button id="fifthForm" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
        </fieldset>
...
<!--enter date of birth-->
        <fieldset class="sixthForm">
            ...
            <button onclick="sixthForm()" id="sixForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            Continue
            </button>
            <p></p>
        </fieldset>
...
<!--Select Employment-->
        <fieldset class="seventhForm">
            ...
            <button id="seventhForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
...
<!--Employment form one-->
        <fieldset class="seventhOneForm">
            ...
            <button id="seventhOneForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            Continue
            </button>
        </fieldset>
...
<!--Employment form one 1-->
        <fieldset class="seventhOneForm1">
            ...
            <button id="seventhOneForm1" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
...
<!--Employment form one 1-->
          <fieldset class="seventhOneForm2">
            ...
            <button id="seventhOneForm2" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
        ...
        <fieldset class="seventhTwoForm">
            ...
            <button id="seventhTwoForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            Continue
            </button>
        </fieldset>
        ...
        <fieldset class="seventhTwoForm1">
            ...
            <button id="seventhTwoForm1" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
    ...
    <!--Employment form Two 2-->
        ...
        <fieldset class="eightthForm">
            ...
            <button id="eightthForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
        ...
        <!-- <fieldset class="borrowAmount">
         ...
         <fieldset class="eightthForm1">
            ...
            <button id="eightthForm1" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
            ...
            <button id="eightthForm2" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
...
<!--        Address Details-->
        <fieldset class="ninethForm" style="display:none">
            ...
            <button id="ninethForms" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
            <button id="AddressLookup1" type="button" name="next" class="next action-button apply-now-continue-btn" style="display:none">
            	Continue
            </button>
        </fieldset>
        ...
        <fieldset class="ninethForm1" >
            ...
            <button id="ninethForms1" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
            <button id="AddressLookup2" type="button" name="next" class="next action-button apply-now-continue-btn" style="display:none">
              Continue
            </button>
        </fieldset>
        ...
        <fieldset class="ninethForm2">
            ...
            <button id="ninethForms2" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
            <button id="AddressLookup3" type="button" name="next" class="next action-button apply-now-continue-btn" style="display:none">
              Continue
            </button>
        </fieldset>
...
<!--Address Details-->
        <fieldset class="tenthForm">
            ...
            <button id="tenthForm" type="button" name="next" class="next action-button apply-now-continue-btn" >
            Continue
            </button>
        </fieldset>
...
<!--Address detail years n months-->
        <fieldset class="eleventhForm">
            ...
            <button id="eleventhForm" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
        </fieldset>
        ...
        <fieldset class="eleventhForm1">
            ...
            <button id="eleventhForm1" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
        </fieldset>
        ...
        <fieldset class="eleventhForm2">
            ...
            <button id="eleventhForm2" type="button" name="next" class="next action-button apply-now-continue-btn" >
            	Continue
            </button>
        </fieldset>
...
<!--Personal Information-->
        <fieldset class="twelvethForm">
            ...
            <button id="twelvethForm" type="button" name="next" class="next action-button apply-now-continue-btn">
            	Continue
            </button>
        </fieldset>
...
<!--getting name-->
        <fieldset class="gettingName">
            ...
            <button id="gettingName" type="button" name="next" class="next action-button apply-now-continue-btn">
            Continue
            </button>
        </fieldset>
<!--        Final Step-->
...
<!--Bank Information-->
        <fieldset class="BankVerification">
            ...
            <button id="verifyBank" type="button" name="next" class="next action-button apply-now-continue-btn">
              Continue
            </button>
        </fieldset>
<!--        Bank Information-->
        ...
        <fieldset class="thirteenthForm">
            <div class="col-sm-12 formDiv radio-group">
                ...
                <div class="col-sm-6 personalInfo">
                    ...
                    <input type="number" placeholder="Mobile number here" class="form-control apply-last-text" name="mobileNumber" id="mobileNumber" style="padding-left: 0px;text-align: center">
          ...
          <!-- <div class="apply-last-p">
              ...
              <div class="float"></div>
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <button type="submit" id="submitButton" name="submitForm" class="next action-button apply-now-continue-btn" style="width: 100%; padding: 0px;">
                      Continue
                    </button>
                </div>
            </div>
...
@include('applyNow.apply-now-backup-js')
@endsection
