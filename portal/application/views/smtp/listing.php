  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div class="page-header position-relative">
        ...
        <h1> SMTP <small> <i class="icon-double-angle-right"></i> Listing </small> 

											<a href="<?php echo base_url(); ?>smtp/setupform" class="btn btn-small btn-primary pull-right">Add<i class="icon-on-right icon-arrow-right"></i></a></h1>
