  ...
  <div class="main-content">
    <div class="page-content">
      <div class="page-header position-relative">
        <h1> Agents <small> <i class="icon-double-angle-right"></i> <?php echo $header['title'];?> </small></h1>
      </div>
      <!--/.page-header-->
      <div class="row-fluid">
        <div class="span12"> 
          ...
          <?php extract($view_data);  //print_r($view_data); 
?>
          <?php $action = (isset($id) && !empty($id)) ? 'agents/add/'.$id : 'agents/add/';?>
          <?php echo form_open( $action,array('id' => 'agents_add')); ?>
                ...
                <div class="widget-body">
                  <div class="widget-main">
                    <?php if($this->session->userdata('userType')=='superadmin'){?>
                      ...
                      <select id="vid" name="vid" class="span12">
