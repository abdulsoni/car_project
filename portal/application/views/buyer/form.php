...
<title>Buyer/Contract Add -</title>
  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div class="page-header position-relative">
        ...
        <h1> Buyer/Contract <small> <i class="icon-double-angle-right"></i> <?php echo $header['title'];?> </small></h1>
      ...
      <div class="row-fluid">
        ...
        <div class="span12">
		  ...
		  <?php $action = (isset($id) && !empty($id)) ? 'buyer/add/'.$id : 'buyer/add/';?>

		  <?php echo form_open( $action,array('id' => 'buyer_add')); ?>
                  ...
                  <div class="widget-body">
                    ...
                    <div class="widget-main">
                      ...
                      <div class="row-fluid">
                        ...
                        <input type="password" name="password" id="password" class="span12<?php if(!isset($id) || empty($id)) echo 'required';?>" placeholder="Password" value="" />
                      ...
                      <div class="row-fluid">
                        ...
                        <input type="password" name="confirmPassword" class="span12" placeholder="Repeat password" value="" />
	...
	$(function() {
		...
		$("#buyer_add").validate({
			...
			rules: {
				...
				company: {lettersonly: true,  minlength: 3},
				//company: {required: true,	accept:"/^[a-z]+$/",  minlength: 3},
