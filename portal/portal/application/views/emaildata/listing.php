  ...
  <div class="main-content">
    ...
    <div class="page-content">
      <div class="page-header position-relative">
        <h1> Email Data <small> <i class="icon-double-angle-right"></i> Listing </small> 
											<a href="<?php echo base_url(); ?>emaildata/form" class="btn btn-small btn-primary pull-right">Add File<i class="icon-on-right icon-arrow-right"></i></a></h1>
      </div>
      <!--/.page-header-->
      <div class="row-fluid">
        <div class="span12">
		...
		<?php }?>
          ...
          <div class="row-fluid">
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
              ...
              <tbody>
			  <?php  foreach($rows as $v){ //print_r($v); die;?>
                <tr>
